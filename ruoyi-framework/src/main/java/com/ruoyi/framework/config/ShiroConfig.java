...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/api/v1/merchants", "anon");   // 附近商家列表：公开浏览
        filterChainDefinitionMap.put("/api/v1/merchants/**", "anon"); // 商家详情+商品：公开浏览
        ...
        filterChainDefinitionMap.put("/api/v1/places/**", "anon"); // 地图选点地址搜索：游客未登录也可选位置（注意：Places 走服务端 key 计费，有匿名滥用风险）
