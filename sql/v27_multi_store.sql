...
SELECT '门店管理', parent_id, 8, '/mall/store', 'C', visible, 'mall:store:view', 'fa fa-map-marker', 'admin', now()
...
('门店查询',  @store_menu_id, 1, '#', 'F', '0', 'mall:store:list',   '#', 'admin', now()),
('门店新增',  @store_menu_id, 2, '#', 'F', '0', 'mall:store:add',    '#', 'admin', now()),
('门店修改',  @store_menu_id, 3, '#', 'F', '0', 'mall:store:edit',   '#', 'admin', now()),
('门店删除',  @store_menu_id, 4, '#', 'F', '0', 'mall:store:remove', '#', 'admin', now());
