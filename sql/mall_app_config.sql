...
INSERT INTO sys_config VALUES(100, 'App-店铺名称',       'app.store.name',         'Dodominimart',          'N', 'admin', now(), 'admin', now(), 'App 首页展示的店铺名称');
INSERT INTO sys_config VALUES(101, 'App-营业时间',       'app.store.hours',        '8:00 AM - 10:00 PM',   'N', 'admin', now(), 'admin', now(), 'App 首页展示的营业时间');
